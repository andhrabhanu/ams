...
import {ComplaintsListDB} from '../list-complaints/ComplaintsListDB';
...
export class ListComplaintsComponent {
  displayedColumns = ['id','owner','date','title'];
    ...
    complaintsListDB = new ComplaintsListDB(this.adminService);
  ...
  export class ExampleDataSource extends DataSource<any> {
    ...
    constructor(private complaintsListDB: ComplaintsListDB) {
      super();
    }
