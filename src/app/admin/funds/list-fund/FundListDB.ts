...
export class FundListDB {
  public apartmentId:any;  
    public bills: any;
  dataChange: BehaviorSubject<FundData[]> = new BehaviorSubject<FundData[]>([]);
  get data(): FundData[] { return this.dataChange.value; }
  ...
  constructor(public adminService: AdminService) {
    ...
    //Get array here
     this.adminService.getFunds(info).then((data) => {
                    this.bills = data;
           //Run Foreach
